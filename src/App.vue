...
/* @font-face {
  ...
  src:url('/static/fonts/NanumBarunGothic.eot') format('embedded-opentype'), url('/static/fonts/NanumBarunGothic.woff') format('woff'), url('/static/fonts/NanumBarunGothic.ttf') format('ttf');
  font-weight:normal;
  font-style:normal;
} */
